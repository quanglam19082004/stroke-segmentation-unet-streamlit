...
*   **Môi trường huấn luyện:** Google Colab (Tesla T4 GPU) / Ubuntu Local Environment
...
1. **Clone repository:**
```bash
   git clone [https://github.com/your-username/stroke-segmentation-unet-streamlit.git](https://github.com/your-username/stroke-segmentation-unet-streamlit.git)
