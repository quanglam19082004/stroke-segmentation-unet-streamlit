...
1. **Clone repository:**
```bash
   git clone [https://github.com/quanglam19082004/stroke-segmentation-unet-streamlit.git](https://github.com/quanglam19082004/stroke-segmentation-unet-streamlit.git)
